...
#define THREAD_KEYS_USER 3480 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 3560 /* offsetof(struct task_struct, thread.keys_kernel) */
